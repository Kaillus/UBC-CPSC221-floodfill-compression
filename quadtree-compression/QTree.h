...
class QTree {
 ...
 private:
  ...
  priority_queue<Node*, vector<Node*>, Compare> leaves; // USER-DEFINED PQ for leaves
  ...
  void copy(Node* thisUpper, Node* copyNext, PNG copyIm);
