...
namespace filler
{
        ...
        */
        ...
        /*                       
        animation vorCusDFS(PNG& img, double density,
                           int stripeSpace, int frameFreq);

        animation vorCusBFS(PNG& img, double density,
                           int stripeSpace, int frameFreq);
        */
    ...
    */
    ...
    bool withinEuclideanVOR(int x, int y, int level, center c);

    template <typename TwoD>
    void addPoint(PNG& img, point& p, colorPicker& fillColor, OrderingStructure<point>& centerOS, 
    TwoD & processed, int& framesSoFar, int frameFreq, animation& newImg);
    ...
    //void findNeighbours(vector<OrderingStructure<point>> & collection, vector<vector<bool>> & processed; int position, point cPoint, int deltaX, int deltaY);
}
